...
class bag3_sync_sar_adc__sar_slice_bot_sync(Module):
    """Module for library bag3_sync_sar_adc cell sar_slice_bot_sync.
    ...
    def design(self, nbits: int, comp: Param, logic: Param, cdac: Param, clkgen:Param,
        ...
        if divcount:
            self.replace_instance_master('XCLK', 'bag3_sync_sar_adc', 
        ...
        self.reconnect_instance_terminal('XDACN', 'sam', 'clk16')
        self.reconnect_instance_terminal('XDACP', 'sam', 'clk16')